...
namespace Aki.AI
{
    public class GSVTTS : TTS
    {
        ...
        [Header("参考音频的语言")]
        [SerializeField] private m_LanguageType m_ReferenceTextLan = m_LanguageType.日文;//参考音频的语言
        [Header("合成音频的语言")]
        [SerializeField] private m_LanguageType m_TargetTextLan= m_LanguageType.中文;//合成音频的语言
        private string m_AudioBase64String = "";//参考音频的base64编码
        [SerializeField] private m_SplitType m_SplitType = m_SplitType.凑四句一切;//合成文本切分方式
        ...
        private void Start()
        {
            DemoBut.onClick.AddListener(() =>
            {
                StartCoroutine(GetVoice("你好", (clip, msg) =>
                {
